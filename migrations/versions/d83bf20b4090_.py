...
Revision ID: d83bf20b4090
Revises: 
Create Date: 2024-03-29 15:45:36.077771
...
def upgrade():
    ...
    sa.Column('billing', sa.String(length=300), nullable=False),
    ...
    sa.Column('special_note', sa.String(length=120), nullable=True),
