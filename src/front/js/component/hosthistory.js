...
export const HostHistory = () => {
    ...
    const listingHistory = listingArray.filter((elm) => (elm.status == "Paid") || (elm.status == "Complete"));
                                                ...
                                                <div className="row d-flex  justify-content-between">
                                                    ...
                                                    <div className="col-9">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-6 pt-2 fs-5">{elm.name}</div>
                                                            <div className="col-6 pt-2 fs-4">
